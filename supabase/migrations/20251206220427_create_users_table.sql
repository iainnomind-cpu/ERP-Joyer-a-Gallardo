...
-- Política para permitir lectura a todos (desarrollo)
...
-- Política para permitir inserción a todos (desarrollo)
...
-- Política para permitir actualización a todos (desarrollo)
...
-- Política para permitir eliminación a todos (desarrollo)
...
VALUES ('admin', 'Administrador', 'admin@gallardojoyas.com', 'admin', true)
ON CONFLICT (username) DO NOTHING;

-- Insertar usuarios de ejemplo
INSERT INTO users (username, full_name, email, role, is_active)
VALUES 
  ('vendedor1', 'María González', 'maria@gallardojoyas.com', 'vendedor', true),
  ('vendedor2', 'Juan Pérez', 'juan@gallardojoyas.com', 'vendedor', true),
  ('cajero1', 'Ana López', 'ana@gallardojoyas.com', 'cajero', true)
ON CONFLICT (username) DO NOTHING;
...
BEGIN
  ...
  RAISE NOTICE '✓ 4 usuarios agregados: 1 admin, 2 vendedores, 1 cajero';
  RAISE NOTICE '✓ Sistema de usuarios listo para usar';
END $$;