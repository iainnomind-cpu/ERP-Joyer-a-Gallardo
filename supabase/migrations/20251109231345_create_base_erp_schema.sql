/*
  # Sistema ERP Gallardo Joyas - Schema Base

  1. Nuevas Tablas
    - `customers` - Clientes del negocio con información de contacto y preferencias
    - `products` - Catálogo de productos con control de stock A/B/C
    - `orders` - Pedidos y cotizaciones
    - `order_items` - Items individuales de pedidos
  ...
  2. Seguridad
    ...
    - Políticas permisivas para usuarios anónimos y autenticados
...
-- Módulo de Ventas: Pedidos y Cotizaciones
...
-- Módulo de Configuración: Reglas de Negocio
...
-- Datos iniciales: Reglas de negocio
