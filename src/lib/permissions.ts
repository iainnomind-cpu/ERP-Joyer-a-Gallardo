...
export type ModuleId = 'dashboard' | 'crm' | 'inventory' | 'sales' | 'config' | 'kanban' | 'marketing' | 'quotes' | 'ecommerce';
...
export const ALL_MODULES: ModuleId[] = ['dashboard', 'crm', 'inventory', 'sales', 'quotes', 'kanban', 'marketing', 'ecommerce', 'config'];
